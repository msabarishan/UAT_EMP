...
# Read Excel File
option = st.selectbox('Select the  requirement?',('Sample_file','Add_Employee','Add_Branch','Add_Supplier','Add_Client','Delete', 'Display','Reset'))
...
if(option=='Reset'):
                    if st.button('Click to Reset'):
                          list1=['DELETE FROM employee','DELETE FROM client','DELETE FROM works_with','DELETE FROM branch_supplier','DELETE FROM branch']
                          for i in range(list1):
                              postgreconnect.runquery(list[i])
                       ...
                       if(option3=='Employee'):
                             ...
                             if st.button('Click to delete'):
                               ...
                               postgreconnect.runquery(delete_script, delete_record)
